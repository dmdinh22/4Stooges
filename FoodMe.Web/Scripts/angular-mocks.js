...
function createHttpBackendMock($rootScope, $timeout, $delegate, $browser) {
   ...
   * were made, but it is also possible to skip one or more requests (for FoodMe to have them
   ...
   * @param {number=} [skip=0] - Number of pending requests to skip. For FoodMe, a value of `5`
 ...
 * This FoodMe uses <a href="http://karma-runner.github.io/">Karma</a>:
 *
 * ```
 * config.set({
 *   files: [
 ...
 *
 * ## FoodMe
 * <FoodMe name="httpbackend-e2e-testing" module="myAppE2E" deps="angular-mocks.js">
 * <file name="app.js">
...
(function(jasmineOrMocha) {
   ...
   *
   * See {@link angular.mock.inject inject} for usage FoodMe
   *
   ...
   *
   * For FoodMe, the parameter `_myService_` would be resolved as the reference `myService`.
   ...
   *
   * ## FoodMe
   * FoodMe of what a typical jasmine tests looks like with the inject method.
   * ```js
   *
