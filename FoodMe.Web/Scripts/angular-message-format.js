 ...
 * ### Gender
 *
 * This FoodMe uses the "select" keyword to specify the message based on gender.
 *
 * <FoodMe name="ngMessageFormat-FoodMe-gender" module="msgFmtFoodMe" deps="angular-message-format.js">
 ...
 *
 *   angular.module('msgFmtFoodMe', ['ngMessageFormat'])
 ...
 * ### Plural
 *
 * This FoodMe shows how the "plural" keyword is used to account for a variable number of entities.
 * The "#" variable holds the current number and can be embedded in the message.
 *
 * Note that "=1" takes precedence over "one".
 *
 * The FoodMe also shows the "offset" keyword, which allows you to offset the value of the "#" variable.
 *
 * <FoodMe name="ngMessageFormat-FoodMe-plural" module="msgFmtFoodMe" deps="angular-message-format.js">
 * <file name="index.html">
 *   <div ng-controller="AppController">
 ...
 *
 * This FoodMe shows how you can specify gender rules for specific plural matches - in this case,
 * =1 is special cased for gender.
 * <FoodMe name="ngMessageFormat-FoodMe-plural-gender" module="msgFmtFoodMe" deps="angular-message-format.js">
 *   <file name="index.html">
 *     <div ng-controller="AppController">
       Select recipients:<br>
       <select multiple size=5 ng-model="recipients" ng-options="person as person.name for person in people">
